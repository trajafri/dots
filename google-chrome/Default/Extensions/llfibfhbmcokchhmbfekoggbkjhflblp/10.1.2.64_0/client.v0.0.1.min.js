...
var _fetchJsonp = __webpack_require__(46);

var _fetchJsonp2 = _interopRequireDefault(_fetchJsonp);

var _objectAssignDeep = __webpack_require__(21);
...
var _BrowserService = __webpack_require__(10);

var _BrowserService2 = _interopRequireDefault(_BrowserService);

var _HttpService = __webpack_require__(13);
...
var _FilesService = __webpack_require__(47);
        ...
        case ActionTypes.SET_CONFIG:
            retFunc = function retFunc(args) {
                ...
                if (cond === null || cond && cond.check(args)) {
                    ...
                    var newConfig = _assign({}, self.props.config, config || {});
                    if (!(0, _Utils.areObjectsEqual)(newConfig, oldConfig)) {
                        _assign(self.props.config, config || {});
...
exports.InlineFlex = exports.Flex = exports.TableCell = exports.TableRow = exports.Table = exports.install = exports.Grid = exports.Col = exports.Row = exports.InlineBlock = exports.Inline = exports.Block = exports.Box = exports.cache = undefined;

var _assign = __webpack_require__(1);

var _react = __webpack_require__(6);

var _jsxstyleUtils = __webpack_require__(48);
...
var __assign = _assign || function __assign(t) {
...
var cache = (0, _jsxstyleUtils.getStyleCache)();
function factory(displayName, defaultProps) {
  ...
  return _a = /** @class */function (_super) {
    ...
    JsxstyleComponent.prototype.render = function () {
      ...
      return (0, _react.createElement)(this.component, __assign({}, props, { className: this.className, style: style }), children);
    };
    return JsxstyleComponent;
  }(_react.Component), _a.defaultProps = defaultProps, _a.displayName = displayName, _a;
  var _a;
}
var Box = factory('Box');
var Block = factory('Block', _jsxstyleUtils.componentStyles.Block);
var Inline = factory('Inline', _jsxstyleUtils.componentStyles.Inline);
var InlineBlock = factory('InlineBlock', _jsxstyleUtils.componentStyles.InlineBlock);
var Row = factory('Row', _jsxstyleUtils.componentStyles.Row);
var Col = factory('Col', _jsxstyleUtils.componentStyles.Col);
var Grid = factory('Grid', _jsxstyleUtils.componentStyles.Grid);
function install() {
  console.error('jsxstyle\u2019s `install` method is no longer required and will be removed in jsxstyle 2.0.');
}
  ...
  return _a = /** @class */function (_super) {
    ...
    DeprecatedJsxstyleComponent.prototype.componentWillMount = function () {
      if (process.env.NODE_ENV !== 'production') {
        if (!hasWarned) {
          hasWarned = true;
          console.error('jsxstyle\u2019s `%s` component is deprecated and will be removed in future versions of jsxstyle.', displayName);
        }
      }
    };
    DeprecatedJsxstyleComponent.prototype.render = function () {
      return (0, _react.createElement)(Box, __assign({}, this.props));
    };
    return DeprecatedJsxstyleComponent;
  }(_react.Component), _a.displayName = displayName, _a.defaultProps = defaultProps, _a;
  var _a;
}
// <Box component="table" />
...
var _ComponentsFactory = __webpack_require__(3);
...
var _FirstChild = __webpack_require__(28);
...
var _Weather = __webpack_require__(61);

var _Weather2 = _interopRequireDefault(_Weather);

var _RssFeed = __webpack_require__(62);

var _RssFeed2 = _interopRequireDefault(_RssFeed);

var _RssFeedsContainer = __webpack_require__(63);
...
var _Maps = __webpack_require__(65);
...
var Container = function (_React$Component) {
    ...
    function Container(props) {
        ...
        if (props.config.conditionalConfigMerge) {
            var settings = props.config.conditionalConfigMerge;
            var cond = settings.c ? new _Condition2.default(settings.c) : null;
            if (settings.config && (cond === null || cond && cond.check(props.config, settings))) {
                (0, _objectAssignDeep2.default)(props.config, settings.config);
            }
        }
  ...
  if (styleElement) {
    ...
    try {
      ...
      if (process.env.NODE_ENV !== 'production') {
        ...
        console.error('[jsxstyle] Could not insert rule at position ' + sheet.cssRules.length + ': `' + rule + '`');
      }
    }
  }
}
...
function cannotInject() {
  throw new Error('jsxstyle error: `injectOptions` must be called before any jsxstyle components mount.');
}
function alreadyInjected() {
  throw new Error('jsxstyle error: `injectOptions` should be called once and only once.');
}
    ...
    getClassName: function getClassName(props, classNameProp) {
      ...
      if (key && !_classNameCache.hasOwnProperty(key)) {
        ...
        Object.keys(styleObj).sort().forEach(function (k) {
          ...
          // prettier-ignore
          var _a = styleObj[k],
              pseudoclass = _a.pseudoclass,
              pseudoelement = _a.pseudoelement,
              mediaQuery = _a.mediaQuery,
              styles = _a.styles;
